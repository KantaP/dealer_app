...
class IdpAsDatasource extends DataSource<IdpAsModel> {
  String tableName = 'idp_as';
  ...
  final logger = Logger('idp-as-datasource');
...
FutureOr disposeDataSource(IdpAsDatasource instance) {
  instance.dispose();
}
