...
class AgentIdpDatasource extends DataSource<IdpModel> {
  String tableName = 'agent_idp';
  ...
  final logger = Logger('agent-idp-datasource');
...
FutureOr disposeDataSource(AgentIdpDatasource instance) {
  instance.dispose();
}
