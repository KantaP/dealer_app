...
final RouteObserver<ModalRoute<void>> modalRouteObserver =
    RouteObserver<ModalRoute<void>>();

abstract class CustomViewScreen<VM extends CustomViewModel>
    extends StatefulWidget {
  final VM viewModel;

  const CustomViewScreen.model(this.viewModel, {Key? key}) : super(key: key);
}

abstract class CustomViewState<V extends CustomViewScreen,
    VM extends CustomViewModel> extends State<V> with RouteAware {
  ...
  @mustCallSuper
  CustomViewState(this._viewModel) {
