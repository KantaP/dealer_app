...
class OrderToReceiveView extends CustomView<OrderToReceiveViewModel> {
  final int idOrder;
  final String refCode;

  const OrderToReceiveView({
    super.key,
    required OrderToReceiveViewModel viewModel,
    required this.idOrder,
    required this.refCode,
  }) : super.model(viewModel);

  @override
  ViewState<OrderToReceiveView, OrderToReceiveViewModel> createState() =>
      _OrderToReceiveViewState(viewModel);
}

class _OrderToReceiveViewState
    extends ViewState<OrderToReceiveView, OrderToReceiveViewModel> {
  _OrderToReceiveViewState(super.viewModel);
    ...
    return ItemSliverPadding(
      child: SliverToBoxAdapter(
        child: Column(
          ...
          children: [
            Text(
              S.of(context).transactionOrderToReceiveWarningTitle,
              style: titleStyle,
            ),
            const SizedBox(
            ...
            Text(
              (snapshot.data!.order!.orderSide == ExchangeMode.buy.name)
                  ? S.of(context).transactionOrderToReceiveWarningContent
                  : S.of(context).transactionOrderToReceiveSellWarningContent,
  ...
  Widget _buildAppBar() {
    return DefaultAppBar(
      ...
      title: S.of(context).transactionOrderToReceiveNavTitle,
