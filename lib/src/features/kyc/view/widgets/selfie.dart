...
class PhotoSelfie extends StatelessWidget {
  const PhotoSelfie({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        HilightText(
          text: S.of(context).kycIntrodunction5Headline,
        ...
        Text(
          S.of(context).kycIntrodunction5Description,
          style: paragraph1LightStyle,
        ),
        Padding(
          padding: const EdgeInsets.only(top: 60.0),
          child: Center(
            child: Image.asset(AssetImages.kycIntroSelfie),
          ),
        )
      ],
    );
