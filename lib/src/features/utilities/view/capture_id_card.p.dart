...
class CaptureIdCardView extends CustomView<CaptureIdCardViewModel> {
  const CaptureIdCardView({required CaptureIdCardViewModel viewModel, Key? key})
      : super.model(viewModel, key: key);

  @override
  _CaptureIdCardViewState createState() => _CaptureIdCardViewState(viewModel);
}

class _CaptureIdCardViewState
    extends ViewState<CaptureIdCardView, CaptureIdCardViewModel> {
  _CaptureIdCardViewState(super.viewModel);
      ...
      children: [
        DefaultLayout(
          ...
          appBar: SliverAppBar(
            ...
            title: Text(
              S.of(context).kycUploadIdCardFrontHeadline,
