...
class AccountManageSubmenuView extends StatelessWidget {
  const AccountManageSubmenuView({super.key});
  ...
  Widget _buildColumnList() {
    final viewModel = DashboardBinding.accountManageSubmenuViewModel;
    return Container(
      color: Colors.white,
